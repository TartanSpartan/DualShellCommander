...
enum LanguageContainer {
  ...
  DUALSHELLCOMMANDER_SETTINGS_MAIN,
  DUALSHELLCOMMANDER_SETTINGS_LANGUAGE,
  DUALSHELLCOMMANDER_SETTINGS_THEME,
  DUALSHELLCOMMANDER_SETTINGS_USBDEVICE,
  DUALSHELLCOMMANDER_SETTINGS_SELECT_BUTTON,
  DUALSHELLCOMMANDER_SETTINGS_NO_AUTO_UPDATE,
  DUALSHELLCOMMANDER_SETTINGS_RESTART_SHELL,
  DUALSHELLCOMMANDER_SETTINGS_POWER,
  DUALSHELLCOMMANDER_SETTINGS_REBOOT,
  DUALSHELLCOMMANDER_SETTINGS_POWEROFF,
  DUALSHELLCOMMANDER_SETTINGS_STANDBY,
  DUALSHELLCOMMANDER_SETTINGS_USB_MEMORY_CARD,
  DUALSHELLCOMMANDER_SETTINGS_USB_GAME_CARD,
  DUALSHELLCOMMANDER_SETTINGS_USB_SD2VITA,
  DUALSHELLCOMMANDER_SETTINGS_USB_PSVSD,
  DUALSHELLCOMMANDER_SETTINGS_SELECT_BUTTON_USB,
  DUALSHELLCOMMANDER_SETTINGS_SELECT_BUTTON_FTP,
  DUALSHELLCOMMANDER_SETTINGS_SELECT_BUTTON_QRC,
