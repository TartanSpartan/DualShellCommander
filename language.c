...
void loadLanguage(int id) {
  ...
  ConfigEntry language_entries[] = {
    ...
    // DualShellCommander settings
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_MAIN),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_LANGUAGE),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_THEME),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_USBDEVICE),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_SELECT_BUTTON),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_NO_AUTO_UPDATE),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_RESTART_SHELL),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_POWER),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_REBOOT),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_POWEROFF),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_STANDBY),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_USB_MEMORY_CARD),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_USB_GAME_CARD),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_USB_SD2VITA),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_USB_PSVSD),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_SELECT_BUTTON_USB),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_SELECT_BUTTON_FTP),
    LANGUAGE_ENTRY(DUALSHELLCOMMANDER_SETTINGS_SELECT_BUTTON_QRC),
  ...
  if (use_custom_config) {
    if (id >= 0 && id < (sizeof(lang) / sizeof(char *))) {
      ...
      snprintf(path, MAX_PATH_LENGTH - 1, "ux0:DualShellCommander/language/%s.txt", lang[id]);
